...
class _TestLayout2State extends State<TestLayout2> {
  ...
  Widget img_() {
    return Container(
      // height: 100,
      // width: 200,
      child: Image.network("https://res.cloudinary.com/enchanting/q_70,f_auto,c_fill,g_face/enchanting-web/2023/09/Graubuenden-Switzerland-with-view-of-houses-on-green-grassy-hills.jpg")
    );
  }
